  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Task3 - Empowering you to organize your life, streamline your workflow, and conquer your day with our intuitive Todo list app."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Task3 - Empowering you to organize your life, streamline your workflow, and conquer your day with our intuitive Todo list app.`}
            </Text>
            <Box
